...
func (d *UserMetadataLocalStore) FactoryUserMetadataStore(
...
func NewUserMetadataLocalStore(umsc *msConfig.UserMetadataStoreConfig,
	storageName string, log zlog.Logger) UserStore {
...
func (umes *UserMetadataEmptyStore) ToggleBookmarkRepo(userid, reponame string) error {
	return nil
}
...
func (umes *UserMetadataEmptyStore) ToggleStarRepo(userid, reponame string) error {
	return nil
}
